...
Hey Guys! This is my own version of zsh. it has a couple cool features that I like a lot built for OS X's terminal. mainly, it senses ambient light in order to set the terminal theme (neat-oh!).
